...
from run_sampling_strategies import analyze_optimality
...
class GOLSAv2NoRL4GW(PolicyBase):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.gr_n_tried = 12  
        self.act_entropy_threshold = 0.8  
        ...
        with torch.no_grad():
            ...
            for distance, state_goal_pairs in shortest_distance_state_goal_pairs.items():
                for s_pos, g_pos in state_goal_pairs:
                    ...
                    subgoal_optimality_state_goal_pairs[distance].append(distance / total_dis)  
...
class GOLSAv2NonRL4TH(GOLSAv2NoRL4GW):
    ...
    def analyze(self,
        ...
        with torch.no_grad():
            ...
            all_g_embs = g_embs[all_kc_ids]  
            all_s_embs = s_embs[all_s_ids]  

            
            
            

            s_combined = self.model.encoding_layers(all_s_embs)  
            g_combined = self.model.g_encoding_layers(all_g_embs)  
            sg_combined = self.goal_reducer.gen_sg(s_combined, g_combined)  
